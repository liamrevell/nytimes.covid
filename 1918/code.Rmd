...
```{r fig.width=12, fig.height=6, units="in", dpi=300, echo=TRUE, fig.cap="Figure 1. Re-iteration of *New York Times* analysis by Denise Lu."}
...
```{r fig.width=12, fig.height=6, units="in", dpi=300, echo=TRUE, fig.cap="Figure 2. Changes in the U.S. age-adjusted death rate through time: re-iterating the methodology of the *New York Times*, but showing absolute, rather than proportional, change."}
...
```{r fig.width=12, fig.height=6, units="in", dpi=300, echo=TRUE, fig.cap="Figure 3. United States age-adjusted death rate / 100,000 population through time from 1900-2020."}
...
```{r fig.width=12, fig.height=6, units="in", dpi=300, echo=TRUE, fig.cap="Figure 4. United States age-adjusted death rate / 100,000 population through time. The observed death rate is indicated by grey (normal) and red (excess) bars. Fewer deaths than expected are indicated by white bars."}
...
```{r fig.width=12, fig.height=6, units="in", dpi=300, echo=TRUE, fig.cap="Figure 5. United States death rate above (or below) 2000-2019 average."}
...
```{r fig.width=12, fig.height=6, units="in", dpi=300, echo=TRUE, fig.cap="Figure 7. Same as Figure 6, but zoomed in to the decades of 1910-1920 and 2010-2020."}
library(plotrix)
...
```{r fig.width=12, fig.height=6, units="in", dpi=300, echo=TRUE, fig.cap="Figure 8. Annual changes in the age-adjusted death rate / 100,000 population using a moving average."}
## moving average
